...
// --- Quadrat der Länge (summe der Quadrate der Komponenten) ---
template <class FLOAT_TYPE, size_t N>
...
FLOAT_TYPE Vector<FLOAT_TYPE, N>::length() const {
  return static_cast<FLOAT_TYPE>(std::sqrt(square_of_length()));
}
*/

// --- Länge des Vektors (unter Verwendung des Skalarprodukts) ---
template <class FLOAT_TYPE, size_t N>
FLOAT_TYPE Vector<FLOAT_TYPE, N>::length() const {
  return static_cast<FLOAT_TYPE>(std::sqrt((*this) * (*this)));
}

// --- Skalarprodukt zweier Vektoren ---
// --- Definition des friend operator* aus math.h ---
